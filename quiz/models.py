...
class StudentFormq(models.Model):
    sub=[('MCCP','MCCP'),('AI','AI'),('DM','DM'),('OS','OS'),('WT','WT')]
    subject=models.CharField(max_length=10,choices=sub,null=True)
    firstname = models.CharField("Enter unit name", max_length=50)  
